...
4. **HIGHLY RECOMMENDED - IMPORTANT**: Install Broesel Hud & the Broesel Hud Customizations. To do this:
   ...
   - NOTE 2: The hud customizations include a custom crosshair. If you do not use the hud, you will need to re-enable the regular crosshair. To do so, go to "koi_cfg/crosshair.cfg" and change the "cl_crosshair_scale" values to "28". Additionally, you will need to go to "koi_cfg\enhancements\zoom_toggle.cfg" and change the values of "cl_crosshair_scale" to "12" on zoomin and "28" on zoomout.
